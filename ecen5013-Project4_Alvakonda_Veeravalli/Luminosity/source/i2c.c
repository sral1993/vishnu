...
void Init_I2C(void)
{
  SIM_SCGC5 = SIM_SCGC5_PORTA_MASK | SIM_SCGC5_PORTB_MASK|SIM_SCGC5_PORTD_MASK;// Turn on clock to PortA and Port E module
  SIM_SCGC4 |= SIM_SCGC4_I2C0_MASK;  // Turn on clock to I2C0 module
  PORTB_PCR0 = PORT_PCR_MUX(2);  // PTE24 pin is I2C0 SCL line
  PORTB_PCR1 = PORT_PCR_MUX(2);  // PTE25 pin is I2C0 SDA line
  /*
  ...
  PORTB_PCR8 |= (0|PORT_PCR_ISF_MASK|     // Clear the interrupt flag
